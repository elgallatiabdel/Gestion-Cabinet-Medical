...
public class IClient extends JPanel {
	JPanel p1, p0;
	JScrollPane p2;
	...
	class addAction implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			if(!versiontf.getText().isEmpty() && !titretf.getText().isEmpty() && !nomtf.getText().isEmpty() && !prenomtf.getText().isEmpty()) {
				ClientDao C = new ClientFactory().getClient(type);
				Client client = new Client(0,Integer.parseInt(versiontf.getText()),titretf.getText(),nomtf.getText(),prenomtf.getText());
				C.addClient(client);
				versiontf.setText("");
				titretf.setText("");
				nomtf.setText("");
				prenomtf.setText("");
				afficheTable();
				IRv.ClientVaidate(type);
				IRv.afficheTable(type);
			}
		}
	}
	class updateAction implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			if(!versiontf.getText().isEmpty() && !titretf.getText().isEmpty() && !nomtf.getText().isEmpty() && !prenomtf.getText().isEmpty()) {
				ClientDao C = new ClientFactory().getClient(type);
				Client client = new Client(this.id,Integer.parseInt(versiontf.getText()),titretf.getText(),nomtf.getText(),prenomtf.getText());
